    ...
    <div className="flex flex-col gap-6 max-w-3xl mx-auto">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl font-semibold text-slate-900">Hackathon Demo Console</h1>
        </div>
        <div className="flex items-center gap-4">
          <LiveIndicator />
          <div className="text-sm text-slate-500">
            <span className="font-semibold text-slate-900">{migratedCount}</span>
            <span className="text-slate-400"> / 6 migrated</span>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-slate-200 bg-white px-5 py-4">
        <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2">Opening (2 min)</div>
        ...
        <div className="mt-3 flex items-center gap-2 flex-wrap">
          <span className="text-[11px] text-slate-500">Show first:</span>
          <a href="/topology" className="inline-flex items-center gap-1 text-[11px] text-sky-600 hover:text-sky-700 font-medium">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        <span className="text-xs text-slate-500 font-medium">Jump to scene:</span>
        ...
        <button
          ...
          className="px-2.5 py-1 rounded-lg text-xs font-medium bg-slate-100 text-slate-500 hover:bg-slate-200 transition-colors ml-auto"
        >
          Reset
        </button>
      </div>
        ...
        <div className="space-y-3">
          <div className="text-xs text-slate-500 space-y-1">
            <div className="flex items-start gap-2">
              ...
              <span>Navigate to <a href="/topology" className="text-sky-600 hover:underline">Topology page</a> — show 2 source QMs, 6 apps</span>
            </div>
            <div className="flex items-start gap-2">
              <ChevronRight className="w-3.5 h-3.5 text-slate-400 shrink-0 mt-0.5" />
              <span>
                Curl <code className="bg-slate-100 px-1 rounded text-[10px]">GET /api/fleet</code> — 2 source QMs in registry
              </span>
            </div>
            <div className="flex items-start gap-2">
              <ChevronRight className="w-3.5 h-3.5 text-slate-400 shrink-0 mt-0.5" />
              <span>Navigate to <a href="/audit" className="text-sky-600 hover:underline">Audit Log</a> — show all provisioning operations</span>
            </div>
          </div>
          <div className="border-t border-slate-100 pt-3">
            <div className="text-xs font-semibold text-slate-600 mb-2">Live policy enforcement test:</div>
        ...
        <div className="space-y-3">
          <div className="text-xs text-slate-500 space-y-1.5">
            <div className="flex items-start gap-2">
              <ChevronRight className="w-3.5 h-3.5 text-slate-400 shrink-0 mt-0.5" />
              <span>
                Navigate to <a href="/migration" className="text-sky-600 hover:underline">Migration Console</a> — APP1 row in IDLE state
              </span>
            </div>
            <div className="flex items-start gap-2">
              <ChevronRight className="w-3.5 h-3.5 text-slate-400 shrink-0 mt-0.5" />
          ...
          <div className="flex items-center gap-3 p-3 rounded-lg border border-slate-200 bg-slate-50">
            <div className="flex-1">
              <div className="text-sm font-semibold text-slate-800">APP1</div>
              <div className="text-[11px] font-mono text-slate-400">QM.SRC.A → QM.APP1</div>
              {app1?.error && (
                <div className="text-[11px] text-red-500 mt-1">{app1.error}</div>
              )}
            </div>
            <div className="shrink-0 flex items-center gap-2">
              <span className={`text-xs font-semibold px-2 py-1 rounded-full ${
                app1State === 'MIGRATED' ? 'bg-emerald-100 text-emerald-700' :
                app1State === 'IDLE' ? 'bg-slate-100 text-slate-600' :
      ...
      {/* Closing */}
      <div className="rounded-xl border border-slate-200 bg-white px-5 py-4">
        <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2">Closing (2 min)</div>
        <div className="text-xs text-slate-500 space-y-1.5">
          <div className="flex items-start gap-2">
            <ChevronRight className="w-3.5 h-3.5 text-slate-400 shrink-0 mt-0.5" />
          ...
          <div className="flex items-start gap-2">
            <ChevronRight className="w-3.5 h-3.5 text-slate-400 shrink-0 mt-0.5" />
            <span>
              Show <a href="/audit" className="text-sky-600 hover:underline">Audit Log</a> — complete chronological trail of every operation
            </span>
          </div>
          <div className="flex items-start gap-2">
            <ChevronRight className="w-3.5 h-3.5 text-slate-400 shrink-0 mt-0.5" />
            <span>
              Show <a href="/validation" className="text-sky-600 hover:underline">Validation Matrix</a> — 18 green badges (6 apps × 3 phases)
            </span>
          </div>
        </div>
        <blockquote className="text-sm text-slate-700 italic border-l-2 border-slate-200 pl-3 mt-3">
